...
export const Personnel = sequelize.define('personnel', {
  ...
  unit_id: { type: DataTypes.BIGINT, defaultValue: 0 },
...
export const ScreenConfig = sequelize.define('screen_config', {
  ...
  layout_config: DataTypes.TEXT,
  widget_config: DataTypes.TEXT,
  status: { type: DataTypes.SMALLINT, defaultValue: 1 },
