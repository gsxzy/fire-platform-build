...
export const IoTDevice = sequelize.define('iot_device', {
  ...
  archive_device_id: { type: DataTypes.BIGINT, allowNull: true, unique: true, comment: '关联 fire_device.id，一台档案设备唯一一条接入记录' },
  ...
  status: { type: DataTypes.SMALLINT, defaultValue: 0, comment: '在线状态：0离线 1在线 2故障' },
  ...
  indexes: [
    ...
    { fields: ['archive_device_id'] },
    { fields: ['device_sn'] },
    { fields: ['ctwing_device_id'] },
