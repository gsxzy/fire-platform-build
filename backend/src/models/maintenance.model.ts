...
export const MaintenanceContract = sequelize.define('maintenance_contract', {
  ...
  status: { type: DataTypes.SMALLINT, defaultValue: 1, comment: '1有效 2到期 3终止' },
...
export const MaintenanceWorkOrder = sequelize.define('maintenance_work_order', {
  ...
  order_type: { type: DataTypes.SMALLINT, allowNull: false, comment: '1巡检 2维修 3保养 4检测' },
  device_id: DataTypes.BIGINT,
  device_name: DataTypes.STRING(100),
  unit_id: DataTypes.BIGINT,
  unit_name: DataTypes.STRING(200),
  fault_desc: DataTypes.TEXT,
  priority: { type: DataTypes.SMALLINT, defaultValue: 1, comment: '1低 2中 3高 4紧急' },
  status: { type: DataTypes.SMALLINT, defaultValue: 0, comment: '0待派单 1处理中 2已完成 3已关闭' },
  ...
  satisfaction: { type: DataTypes.SMALLINT, comment: '1-5星' },
...
export const MaintenanceRecord = sequelize.define('maintenance_record', {
  ...
  work_order_id: DataTypes.BIGINT,
  device_id: DataTypes.BIGINT,
  device_name: DataTypes.STRING(100),
  unit_id: DataTypes.BIGINT,
  unit_name: DataTypes.STRING(200),
  ...
  status: { type: DataTypes.SMALLINT, defaultValue: 0, comment: '0待完成 1已完成' },
  material_cost: DataTypes.DECIMAL(10, 2),
  labor_cost: DataTypes.DECIMAL(10, 2),
}, {
