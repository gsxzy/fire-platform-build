...
export const DutyShiftDef = sequelize.define('DutyShiftDef', {
  ...
  rotation_type: { type: DataTypes.SMALLINT, defaultValue: 1, comment: '轮班类型：1固定 2轮班 3临时' },
  sort_order: { type: DataTypes.SMALLINT, defaultValue: 0, comment: '排序' },
  description: { type: DataTypes.TEXT, comment: '描述' },
  status: { type: DataTypes.SMALLINT, defaultValue: 1, comment: '0停用 1启用' },
}, {
