...
export const User = sequelize.define('user', {
  ...
  dept_id: { type: DataTypes.BIGINT, defaultValue: 0 },
}, {
  tableName: 'sys_user',
  comment: '系统用户表',
  indexes: [
...
export const Permission = sequelize.define('permission', {
  ...
  type: { type: DataTypes.SMALLINT, defaultValue: 1, comment: '1菜单 2按钮 3接口' },
...
export const RolePermission = sequelize.define('role_permission', {
  role_id: { type: DataTypes.BIGINT, allowNull: false },
  perm_id: { type: DataTypes.BIGINT, allowNull: false },
}, {
