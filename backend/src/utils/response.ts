export const success = (data: unknown, msg = '操作成功') => ({ code: 200, message: msg, data, timestamp: Date.now() });
export const fail = (msg = '操作失败', code = 400) => ({ code, message: msg, data: null, timestamp: Date.now() });
export const page = (list: unknown[], total: number, pageNum: number, pageSize: number) => ({
