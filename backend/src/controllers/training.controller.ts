...
export const TrainingController = {
  /* ── 课程 ── */
  courseList: makeListHandler(TrainingCourse),
  courseCreate: makeCreateHandler(TrainingCourse),
  courseUpdate: makeUpdateHandler(TrainingCourse),
  courseDelete: makeDeleteHandler(TrainingCourse),
