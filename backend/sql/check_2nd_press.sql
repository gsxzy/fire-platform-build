...
SELECT id, device_sn, loop_no, address, status, alarm_type, alarm_time FROM fire_platform.fscn8001_alarm WHERE device_sn = '2211AA3B0000000000000000' ORDER BY id DESC LIMIT 3;
