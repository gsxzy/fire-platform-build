...
export declare const SystemController: {
    ...
    personnelList(req: Request, res: Response): Promise<void>;
    personnelCreate(req: Request, res: Response): Promise<void>;
    personnelUpdate(req: Request, res: Response): Promise<void>;
    personnelDelete(req: Request, res: Response): Promise<void>;
    monitor(req: Request, res: Response): Promise<void>;
};
