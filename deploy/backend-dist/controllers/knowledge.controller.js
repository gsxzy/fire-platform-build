...
exports.KnowledgeController = {
    ...
    async create(req, res) {
        try {
            const doc = await models_1.KnowledgeDoc.create(sanitizeBody(req.body));
    ...
    async update(req, res) {
        try {
            await models_1.KnowledgeDoc.update(sanitizeBody(req.body), { where: { id: sanitizeId(req.params.id) } });
    ...
    async delete(req, res) {
        try {
            await models_1.KnowledgeDoc.destroy({ where: { id: sanitizeId(req.params.id) } });
