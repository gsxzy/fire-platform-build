...
timeout 25 tcpdump -i any -nn -q "udp and src host 42.91.136.196" > "$LOG" 2>&1 &
echo $! > "$PIDFILE"
sleep 2

# Send a UDP packet to camera to trigger NAT mapping
echo "nat-test" | nc -u -w1 42.91.136.196 34107
sleep 1
