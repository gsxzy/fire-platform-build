...
-- 使用 COLLATE 统一排序规则避免字符集冲突
UPDATE fire_iot_device i
INNER JOIN fire_device d
  ON (
    (d.device_sn IS NOT NULL AND d.device_sn <> '' AND i.device_sn COLLATE utf8mb4_general_ci = d.device_sn COLLATE utf8mb4_general_ci)
    OR (i.device_sn COLLATE utf8mb4_general_ci = d.device_no COLLATE utf8mb4_general_ci)
  )
