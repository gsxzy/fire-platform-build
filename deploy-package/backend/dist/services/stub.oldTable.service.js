...
exports.gb28181DeviceUpdate = gb28181DeviceUpdate;
...
exports.gb28181DeviceById = makeById('gb28181_devices');
exports.gb28181DeviceCreate = makeCreate('gb28181_devices');
async function gb28181DeviceUpdate(req, res) {
    try {
        ...
        logger_1.default.error('[Stub] gb28181DeviceUpdate', err);
        res.status(500).json((0, response_1.fail)(`更新失败: ${err?.message || '未知错误'}`, 500));
    }
}
exports.gb28181DeviceDelete = makeDelete('gb28181_devices');
