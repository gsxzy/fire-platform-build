...
export declare class FSCN8001Server extends BaseProtocolServer<FSCN8001Connection> {
    ...
    private saveRawLog;
    private insertAlarm;
    protected createUnifiedAlarm(deviceSn: string, alarmType: string, alarmLevel: string, description: string | null, rawData: string | null, deviceType?: number | null, loopNo?: number | null, address?: number | null, hostCode?: number | null): Promise<void>;
}
